...
export class ToursMainPage {
    readonly toursPage: Page;
    ...
    constructor(page) {
        ...
        this._months = page.locator(this._dropdownLocator).locator('[class="aa2f"]');
        this._toggleBlock = page.locator(this._dropdownLocator).locator('[class="ta4a"]')
        ...
        this._quantityButtons = page.locator(this._dropdownLocator).locator('[class*="fa3a"]')
        this._quantityValues = page.locator(this._dropdownLocator).locator('[class*="a3af"]')
    ...
    async openToursPage() {
        await this.toursPage.goto('https://ozon.ru/travel/tours')
    }
    ...
    async expectNightsToggleIsApplied() {
        await expect(this._nightsField.locator('[class="a6ta"]')).toHaveAttribute('data-night-round', '±2');
    }
